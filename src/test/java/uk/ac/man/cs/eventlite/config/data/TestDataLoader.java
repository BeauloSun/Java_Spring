...
public class TestDataLoader {
	...
	CommandLineRunner initDatabase() {
		return args -> {
			// Build and save test events and venues here. The test database is
			// configured to reside in memory, so must be initialized every
			// time.
	...
	private void createVenue(String name, String address, Integer capacity, Boolean setCoords)
		...
		if (setCoords)
			venue.setCoords(mapboxService.geocode(address));
